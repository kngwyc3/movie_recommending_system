...
function useDragHandle(state) {
  ...
  var handleDragStart = function handleDragStart(state2) {
    ...
    tree_utils_index.emitEvent(props, context, "drag-start", ctx);
  };
  var handleDragEnd = function handleDragEnd(state2) {
    ...
    tree_utils_index.emitEvent(props, context, "drag-end", ctx);
  };
  var handleDragOver = function handleDragOver(state2) {
    ...
    tree_utils_index.emitEvent(props, context, "drag-over", ctx);
  };
  var handleDragLeave = function handleDragLeave(state2) {
    ...
    tree_utils_index.emitEvent(props, context, "drag-leave", ctx);
  };
  var handleDrop = function handleDrop(state2) {
    ...
    tree_utils_index.emitEvent(props, context, "drop", ctx);
  };
  var drag = {
