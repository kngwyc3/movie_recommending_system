...
declare const _default: {
    ...
    readonly form: {
        readonly errorMessage: {
            ...
            readonly max: "${name} cannot be longer than ${validate} characters";
            readonly min: "${name} must be at least ${validate} characters";
